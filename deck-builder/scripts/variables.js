...
const ELEMENTS = {
    ...
    sidebar: document.getElementsByTagName("side-panel")[0],
    sidebarTab: document.getElementsByTagName("side-panel-tab")[0],
    sidebarTopContainer: document.getElementsByTagName('side-panel-top-container')[0],
